...
# global param
predict_server_name = "grpc_exploreGRRetrMoe"
model_queue_prefix="kaiworks_explore_sid_trans_yzc_v3_256_moe_gt30"
            ...
            self.uni_predict_fused(
              ...
              ## embedding 拉取相关配置，对应 fetch_mio_embedding 部分
               embedding_fetchers = [dict(
                ...
                colossusdb_embd_table_name="gr_emb_moe",
              ...
              executor_config = dict(
                context_per_device=9,  				# 每张卡上设置的 context 个数，
