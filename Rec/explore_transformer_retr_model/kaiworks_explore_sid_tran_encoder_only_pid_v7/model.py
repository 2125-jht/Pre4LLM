...
class MultiInterestModel(object):
    ...
    def model(self, user_colossus_play_time_list, user_colossus_duration_list, user_colossus_channel_list, photo_sid, label, photo_semantic_id_int):
        ...
        # === 3. 构建编码器输入 ===
        encoder_input = tf.concat([user_static_emb, user_colossus_emb, user_profile_emb, user_realtime_emb], axis=1)
        ...
        # === 3-A. padding mask 更新 ===============================
        # 总序列长度
        total_len = 1 + colossus_max_len + profile_max_len + realtime_max_len
        ...
        # 拼整条 mask
        seq_mask = tf.concat([user_tok, colossus_mask, profile_mask, realtime_mask], axis=1)  # [B,total_len]
