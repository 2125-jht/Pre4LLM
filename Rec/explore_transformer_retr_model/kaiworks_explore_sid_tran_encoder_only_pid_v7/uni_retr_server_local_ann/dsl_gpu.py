...
# global param
predict_server_name = "grpc_exploreGRRetr256_256"
model_queue_prefix="kaiworks_explore_sid_trans_yzc_v7"
model_dir = "predict/conf_gpu"
param_json = "parameter_config.json"
PXTRS = ['user_sid_origin', "user_sid_prob", "play_time_shape", "duration_shape", "channel_shape", "click_shape"]
sign_format = "mio"
shard_offset = 0
queue_shard_num = 1
EMBEDDING_SHARDS = 1
            ...
            self.uni_predict_fused(
              ...
              ## embedding 拉取相关配置，对应 fetch_mio_embedding 部分
               embedding_fetchers = [dict(
                ...
                colossusdb_embd_model_name="fountain_gr_retr",
                colossusdb_embd_table_name="gr_emb_v7",
              ...
              executor_config = dict(
                context_per_device=10,  				# 每张卡上设置的 context 个数，
                memory_size_per_context=2048, # 每个 context 占用的显存，单位 MB
              ),
            )
            .log_debug_info(
      ...
      return self.copy_user_meta_info(
        ...
        .enrich_with_protobuf(
          ...
          attrs=[
            ...
            dict(path="user_profile.user_level", name="user_level"),
            dict(path="location.city_level", name="city_level"),
            dict(path="request_location.province_id", name="request_province_id"),
            dict(path="user_profile_v1.click_list.photo_id", name="user_profile_v1_click_pid_list"),
            dict(path="user_profile_v1.click_list.author_id", name="user_profile_v1_click_aid_list"),
          ]
        ) \
        .enrich_attr_by_light_function(
          ...
          export_common_attr = [
            {"name": "explore_click_pid_list", "as": "user_profile_v1_explore_click_pid_list"},
            {"name": "explore_click_aid_list", "as": "user_profile_v1_explore_click_aid_list"},
          ],
          function_name = "FilterExploreClickUserProfileV1",
        ...
        .log_debug_info(
          common_attrs = [
            ...
            "user_profile_v1_explore_click_pid_list",
            "user_profile_v1_explore_click_aid_list",
            "user",
          ],
          for_debug_request_only = True,
          respect_sample_logging = False,
        ...
        .enrich_attr_by_lua(
          ...
          export_common_attr = ["has_colossus",],
          lua_script = """
            function calculate()
              local has_colossus = 1
              if colossus_photo_id_list == nil then
                has_colossus = 0
              end
              return has_colossus
            end
        ...
        .pack_common_attr(
          input_common_attrs = ["colossus_photo_id_list"],
          output_common_attr = "colossus_photo_id_list_limit",
          limit_num = 1000,
        ) \
        .pack_common_attr(
          input_common_attrs = ["colossus_author_id_list"],
          output_common_attr = "colossus_author_id_list_limit",
          limit_num = 1000,
        ) \
        .pack_common_attr(
          input_common_attrs = ["colossus_play_time_list"],
          output_common_attr = "colossus_play_time_list_limit",
          limit_num = 1000,
        ) \
        .pack_common_attr(
          input_common_attrs = ["colossus_duration_list"],
          output_common_attr = "colossus_duration_list_limit",
          limit_num = 1000,
        ) \
        .pack_common_attr(
          input_common_attrs = ["colossus_channel_list"],
          output_common_attr = "colossus_channel_list_limit",
          limit_num = 1000,
        ) \
        .reverse_list_attr(
          common_attrs=[
            "colossus_photo_id_list_limit", 
            "colossus_author_id_list_limit",
            "colossus_play_time_list_limit",
            "colossus_duration_list_limit",
            "colossus_channel_list_limit"
          ]
        ) \
        .cast_attr_type(
          attr_type_cast_configs=[
            {
              "to_type": "double",
              "from_common_attr": "colossus_play_time_list_limit",
              "to_common_attr": "colossus_play_time_list",
            },
            {
              "to_type": "double",
              "from_common_attr": "colossus_duration_list_limit",
              "to_common_attr": "colossus_duration_list",
            },
            {
              "to_type": "double",
              "from_common_attr": "colossus_channel_list_limit",
              "to_common_attr": "colossus_channel_list",
            }
          ]
        ) \
        .explore_extract_universal_feature(
          ...
          mode = "infer",
          models = [
            "grpc_KaiWorksExploreSidTransRetr",
          ],
          ...
          user_info_attrs = {
            ...
            "user_profile_user_level_attr": "user_level",
            "user_colossus_pid_list_attr": "colossus_photo_id_list_limit",
            "user_colossus_aid_list_attr": "colossus_author_id_list_limit",
            "user_profile_v1_click_pid_list_attr": "user_profile_v1_click_pid_list",
            "user_profile_v1_click_aid_list_attr": "user_profile_v1_click_aid_list",
            "user_profile_v1_explore_click_pid_list_attr": "user_profile_v1_explore_click_pid_list",
            "user_profile_v1_explore_click_aid_list_attr": "user_profile_v1_explore_click_aid_list",
          },
          photo_info_attrs = {
          },
