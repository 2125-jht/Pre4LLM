...
# global param
predict_server_name = "grpc_fountainRetrV3"
            ...
            self.uni_predict_fused(
              ...
              ## embedding 拉取相关配置，对应 fetch_mio_embedding 部分
               embedding_fetchers = [dict(
                ...
                colossusdb_embd_table_name="gr_emb_v6",
...
service.build(output_file=os.path.join(model_dir, "dynamic_json_config_gpu_fountain.json"))
