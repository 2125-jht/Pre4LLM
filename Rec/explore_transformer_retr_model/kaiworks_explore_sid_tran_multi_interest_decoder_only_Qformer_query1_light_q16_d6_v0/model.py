...
class MultiInterestModel(object):
    ...
    def beam_search_fast_share_head(self, beam_size=16, temperature=1):
        """
        ...
        * step>0 时保持固定 beam_size。
        ...
        all_seqs, all_probs, all_scores = beam_search_group(coarse_interest, self._query_token_numb, beam_size)
        output_beam_size = self._query_token_numb * beam_size
