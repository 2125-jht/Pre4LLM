...
if is_training:
    ...
    user_sid0 = tf.cast(config.get_dense_fea("top10_sid0", dim=10, dtype=tf.float32), tf.int32)
    user_sid, user_sid_prob = model.beam_search_fast_share_head(user_sid0, beam_size=190, temperature=1, hot_beam_size=190)
