...
class MultiInterestModel(object):
    ...
    def model(self, photo_sid, label, photo_semantic_id_int):
        ...
        fine_item_model = DecoderModel(num_layers=2, dim=self._stage_two_dim, num_heads=8, dropout_rate=0.1, hidden_dim=self._stage_two_dim*2, training=True, query_token_numb=self._query_token_numb)
