...
if is_training:
    ...
    user_sid, user_sid_prob, query_indices = model.beam_search_fast_share_head(beam_size=50, temperature=1)
    ...
    query_indices_flat = tf.cast(query_indices, tf.float32)
    ...
    user_targets = [
        ...
        ("query_indices", query_indices_flat)
    ]
