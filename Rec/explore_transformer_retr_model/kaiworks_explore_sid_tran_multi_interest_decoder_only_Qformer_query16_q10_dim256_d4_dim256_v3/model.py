...
class MultiInterestModel(object):
    ...
    def model(self, photo_sid, label, photo_semantic_id_int):
        ...
        coarse_interest_input = tf.nn.embedding_lookup(self._query_embedding, query_token_indice)#[b,q,dim]
        ...
        coarse_interest_model = QFormer(num_layers=10, dim=self._stage_one_dim, num_heads=8, dropout_rate=0.1, hidden_dim=self._stage_one_dim*2, training=True)
