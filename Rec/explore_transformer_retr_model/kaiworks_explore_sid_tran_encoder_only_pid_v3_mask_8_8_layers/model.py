...
class MultiInterestModel(object):
    ...
    def model(self, photo_sid, label, photo_semantic_id_int):
        ...
        encoder_model = EncoderModel(num_layers=8, dim=self._dim, num_heads=8, dropout_rate=0.1, hidden_dim=self._dim*2, training=True)
        ...
        decoder_model = DecoderModel(num_layers=8, dim=self._dim, num_heads=8, dropout_rate=0.1, hidden_dim=self._dim*2, training=True)
    ...
    #     encoder_model = EncoderModel(num_layers=8, dim=self._dim, num_heads=8, dropout_rate=0.1, hidden_dim=self._dim*2)
    #     decoder_model = DecoderModel(num_layers=8, dim=self._dim, num_heads=8, dropout_rate=0.1, hidden_dim=self._dim*2)
