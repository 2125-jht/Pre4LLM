...
# debug feature
# print_ops.append(tf.print("feature 22:",
#                         config.get_sparse_fea("22", dim=1), summarize=100))
# print_ops.append(tf.print("feature 16:",
#                         tf.cast(config.get_sparse_fea("16", dim=1)[0], dtype=tf.int64)[:5], summarize=100))
# print_ops.append(tf.print("feature dense 16:",
#                         config.get_dense_fea("user_info__id", dim=1, dtype=tf.int64)[:5], summarize=100))
