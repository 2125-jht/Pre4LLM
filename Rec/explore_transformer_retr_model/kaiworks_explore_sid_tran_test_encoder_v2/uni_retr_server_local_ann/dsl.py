...
# global param
predict_server_name = "grpc_exploreGRRetrCpu"
model_queue_prefix="kaiworks_explore_sid_tran_retr"
model_dir = "predict/conf"
param_json = "parameter_config.json"
PXTRS = ['user_sid_origin', 'user_sid_int']
sign_format = "mio"
shard_offset = 0
queue_shard_num = 1
EMBEDDING_SHARDS = 1
            ...
            self.uni_predict_fused(
              ...
              ## embedding 拉取相关配置，对应 fetch_mio_embedding 部分
               embedding_fetchers = [dict(
                ...
                colossusdb_embd_table_name="gr_emb",
