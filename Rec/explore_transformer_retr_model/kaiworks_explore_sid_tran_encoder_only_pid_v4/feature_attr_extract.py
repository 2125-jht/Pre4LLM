...
all_feats = {
    ...
    # === 用户行为序列特征 ===
    # "user_profile_v1_click_pid_list": {"expand": 200},  # 用户点击视频ID列表
    # "user_profile_v1_click_aid_list": {"expand": 200},  # 用户点击作者ID列表
    
    "user_colossus_pid_list": {"expand": 200},
    "user_colossus_aid_list": {"expand": 200},
