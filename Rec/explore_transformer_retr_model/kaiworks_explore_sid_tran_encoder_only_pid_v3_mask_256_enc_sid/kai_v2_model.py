...
if is_training:
    ...
    # === 模型前向传播 ===
    print("=== 模型前向传播 ===")
    loss, result_dict = model.model(user_profile_v1_click_semantic_id_list, photo_semantic_id, label, photo_semantic_id_int)  # 计算训练损失
    ...
    user_profile_v1_click_semantic_id_list = config.get_dense_fea("user_profile_v1_click_semantic_id_list", dim=200, dtype=tf.int64) # [B, 200]
    user_sid, user_sid_prob = model.beam_search_fast(user_profile_v1_click_semantic_id_list, beam_size=512, temperature=1)
