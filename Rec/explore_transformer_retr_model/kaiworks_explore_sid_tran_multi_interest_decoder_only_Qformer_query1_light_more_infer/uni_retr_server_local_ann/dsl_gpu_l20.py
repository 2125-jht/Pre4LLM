...
# global param
predict_server_name = "grpc_exploreGRRetrfp16"
model_queue_prefix="kaiworks_explore_sid_tran_multi_interest_decoder_only_Qformer_query1_light_more_final"
            ...
            self.uni_predict_fused(
              ...
              ## embedding 拉取相关配置，对应 fetch_mio_embedding 部分
               embedding_fetchers = [dict(
                ...
                colossusdb_embd_table_name="gr_multi_query1_light_more_gpu_final",
