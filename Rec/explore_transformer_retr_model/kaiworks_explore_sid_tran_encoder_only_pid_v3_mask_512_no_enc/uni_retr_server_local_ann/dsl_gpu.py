...
# global param
predict_server_name = "grpc_exploreGRRetr512DimNoEnc"
model_queue_prefix="kaiworks_explore_sid_trans_yzc_v3_512_no_enc"
            ...
            self.uni_predict_fused(
              ...
              ## embedding 拉取相关配置，对应 fetch_mio_embedding 部分
               embedding_fetchers = [dict(
                ...
                colossusdb_embd_table_name="gr_no_enc_512",
