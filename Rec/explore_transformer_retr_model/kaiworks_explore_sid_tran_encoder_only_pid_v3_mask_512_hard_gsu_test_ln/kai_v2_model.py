...
if is_training:
    ...
    # === 模型前向传播 ===
    print("=== 模型前向传播 ===")
    loss = model.model(user_profile_v1_click_semantic_id_list, photo_semantic_id, label, photo_semantic_id_int)  # 计算训练损失
    ...
    user_profile_v1_click_semantic_id_list = config.get_dense_fea("user_profile_v1_click_semantic_id_list", dim=600, dtype=tf.int64) # [B, 200]
