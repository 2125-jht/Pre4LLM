...
if is_training:
    ...
    user_profile_v1_click_semantic_id_list = config.get_dense_fea("user_profile_v1_click_semantic_id_list", dim=200, dtype=tf.int64) # [B, 200]

    loss = model.model(user_profile_v1_click_semantic_id_list, photo_semantic_id_int)
    ...
    user_sid, user_sid_prob = model.beam_search_fast(user_colossus_photo_semantic_id_list, beam_size=512, temperature=1)
