...
if is_training:
    ...
    # === 模型前向传播 ===
    print("=== 模型前向传播 ===")
    loss = model.model(user_profile_v1_click_semantic_id_list, colossus_photo_semantic_id_list, photo_semantic_id, label, photo_semantic_id_int)  # 计算训练损失
    ...
    user_profile_v1_click_semantic_id_list = config.get_dense_fea("user_profile_v1_click_semantic_id_list", dim=600, dtype=tf.float32) * 1000 # [B, 200]

    user_profile_v1_click_semantic_id_list = tf.reshape(user_profile_v1_click_semantic_id_list, [-1, 3, 200])[:, 0, ]
    user_profile_v1_click_semantic_id_list = tf.cast(user_profile_v1_click_semantic_id_list, dtype=tf.int32)
    ...
    user_sid, user_sid_prob = model.beam_search_fast(user_profile_v1_click_semantic_id_list, colossus_semantic_id_list, beam_size=512, temperature=1)
