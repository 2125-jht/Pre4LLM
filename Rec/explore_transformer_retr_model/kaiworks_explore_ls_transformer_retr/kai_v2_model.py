...
if is_training:
    ...
    loss = model._multi_interest_encode_v2(photo_semantic_id, label, photo_semantic_id_int)  # 计算训练损失
    ...
    audit = config.get_dense_fea("photo_info__audit_b_second_tag", dim=1, dtype=tf.int64)
