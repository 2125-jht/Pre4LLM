...
copy_feats = {
    # 示例配置（已注释）：
    "user_id": [("user_id_dec", 8016, default_dim)],
    "user_gender": [("user_gender_dec", 8022, default_dim)],
    "user_age_segment": [("user_age_segment_dec", 8018, default_dim)],
    "user_level": [("user_level_dec", 8027, default_dim)],
    # "photo_id": [
