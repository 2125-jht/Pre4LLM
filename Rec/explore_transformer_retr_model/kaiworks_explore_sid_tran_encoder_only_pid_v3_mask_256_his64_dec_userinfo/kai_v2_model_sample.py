...
if is_training:
    ...
    user_sid, user_sid_prob = model.beam_search_fast_sampling(beam_size=20, temperature=1)
    ...
    user_sid, user_sid_prob = model.beam_search_fast_sampling(beam_size=512, temperature=1)
    ...
    config.dump_predict_config('./uni_retr_server_local_ann/predict/conf_gpu_sample/', user_targets, input_type=3, extra_preds=q_names, dump_mode="user_predict")
