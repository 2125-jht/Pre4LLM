...
# global param
predict_server_name = "grpc_exploreGR_PRM"
model_queue_prefix="kaiworks_explore_sid_tran_decoder_only_PRM"
            ...
            self.uni_predict_fused(
              ...
              ## embedding 拉取相关配置，对应 fetch_mio_embedding 部分
               embedding_fetchers = [dict(
                ...
                colossusdb_embd_table_name="kaiworks_explore_sid_tran_decoder_only_PRM_v1",
