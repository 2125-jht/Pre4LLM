...
model_queue_prefix="kaiworks_foutain_sid_trans_retr_v3"
            ...
            self.uni_predict_fused(
              ...
              ## embedding 拉取相关配置，对应 fetch_mio_embedding 部分
               embedding_fetchers = [dict(
                ...
                colossusdb_embd_table_name="gr_fountain_emb",
      ...
      return self.copy_user_meta_info(
        ...
        .parse_protobuf_from_string(
          ...
          attrs=[
            ...
            dict(path="fountain_reco_user_profile.click_list.photo_id", name="fountain_click_photo_id"),
            dict(path="fountain_reco_user_profile.click_list.author_id", name="fountain_click_author_id"),
          ]
        ) \
        .enrich_attr_by_lua(
          import_common_attr = ["fountain_click_photo_id", "fountain_click_author_id"],
          function_for_common = "calculate",
          export_common_attr = ["fountain_click_photo_id_size", "fountain_click_author_id_size", "has_fountain_click_photo_id", "has_fountain_click_author_id"],
          lua_script = """
            function calculate()
              local has_fountain_click_photo_id = 1
              local has_fountain_click_author_id = 1
              if fountain_click_photo_id == nil then
                has_fountain_click_photo_id = 0
              end
              if fountain_click_author_id == nil then
                has_fountain_click_author_id = 0
              end
              local fountain_click_photo_id = fountain_click_photo_id or {}
              local fountain_click_author_id = fountain_click_author_id or {}
              return #fountain_click_photo_id, #fountain_click_author_id, has_fountain_click_photo_id, has_fountain_click_author_id
            end
          """
        ) \
        .perflog_attr_value(
          check_point="default.ranking",
          common_attrs=["fountain_click_photo_id_size", "fountain_click_author_id_size", "has_fountain_click_photo_id", "has_fountain_click_author_id"],
        ) \
        .log_debug_info(
          common_attrs = [
            "uId",
            ...
            "user_level",
            "city_level",
            "fountain_click_photo_id",
            "fountain_click_author_id",
            "user",
          ],
          trace_user_ids = ['2247926388', '1370638810', '2404126583', '460862097'],
          log_tag = "mxj"
        ) \
        .explore_extract_universal_feature(
          ...
          user_info_attrs = {
            ...
            "user_fountain_profile_click_pid_list_attr": "fountain_click_photo_id",
            "user_fountain_profile_click_aid_list_attr": "fountain_click_author_id",
          },
          photo_info_attrs = {
          },
