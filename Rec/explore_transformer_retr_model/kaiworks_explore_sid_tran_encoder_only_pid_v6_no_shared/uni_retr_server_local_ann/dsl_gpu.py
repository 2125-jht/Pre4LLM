...
# global param
predict_server_name = "grpc_exploreGRRetrV2"
model_queue_prefix="kaiworks_explore_sid_trans_yzc_v6"
            ...
            self.uni_predict_fused(
              ...
              ## embedding 拉取相关配置，对应 fetch_mio_embedding 部分
               embedding_fetchers = [dict(
                ...
                colossusdb_embd_table_name="gr_emb_v6_2",
...
#            "user_gender_attr": "uGender",
    ...
    def retrieve(self):
      ...
      .enrich_attr_by_lua(
        ...
        export_item_attr = ["query_sid_list", "query_sid", "prob1", "prob2", "prob3", "logp"],
        lua_script = """
          function calculate()
            ...
            logp = math.log(prob1*prob2*prob3)
            return query_sid_list, query_int, prob1, prob2, prob3, logp
          end
        """
      ) \
       .pack_item_attr(
