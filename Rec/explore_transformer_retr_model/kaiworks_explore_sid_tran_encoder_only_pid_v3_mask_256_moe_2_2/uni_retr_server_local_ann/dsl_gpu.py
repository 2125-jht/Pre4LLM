...
# global param
predict_server_name = "grpc_exploreGRRetrMoeNoLag"
    ...
    def prepare(self):
      return self.copy_user_meta_info(
        ...
        .get_abtest_params(
          biz_name = "RECO_RPC",
          ab_params = [
            ("explore_h3452_skip_ratio", 0.3),
          ]
        ) \
        .enrich_attr_by_lua(
          import_common_attr = ["explore_h3452_skip_ratio"],
          export_common_attr = ["skip"],
          ...
          lua_script = """
            function calculate()
              ...
              local skip = 0
              if random < explore_h3452_skip_ratio then
                skip = 1
              end
              return skip
            end
