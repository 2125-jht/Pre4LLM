...
if is_training:
    ...
    user_sid, user_sid_prob = model.beam_search_fast_more(beam_size=512, last_size=2048, temperature=1)
    ...
    config.dump_predict_config('./uni_retr_server_local_ann/predict/conf_gpu_more/', user_targets, input_type=3, extra_preds=q_names, dump_mode="user_predict")
