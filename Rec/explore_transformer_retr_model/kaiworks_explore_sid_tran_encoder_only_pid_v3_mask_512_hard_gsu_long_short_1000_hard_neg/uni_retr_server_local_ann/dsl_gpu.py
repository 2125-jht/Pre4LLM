...
# global param
predict_server_name = "grpc_exploreGRRetrLongShortHardGsu"
model_queue_prefix="kaiworks_explore_sid_trans_yzc_v3_512_hard_gsu_long_short"
            ...
            self.uni_predict_fused(
              ...
              ## embedding 拉取相关配置，对应 fetch_mio_embedding 部分
               embedding_fetchers = [dict(
                ...
                colossusdb_embd_table_name="gr_long_short_gsu",
              ...
              executor_config = dict(
                ...
                memory_size_per_context= 15000, # 每个 context 占用的显存，单位 MB
              ),
            )
            .log_debug_info(
      ...
      return self.copy_user_meta_info(
        ...
        .parse_protobuf_from_string(
          ...
          attrs=[
            ...
            dict(path="user_profile_v1.click_list.photo_id", name="click_photo_id"),
            dict(path="user_profile_v1.click_list.author_id", name="click_author_id"),
        ...
        .fetch_remote_embedding(
          ...
          id_converter = {"type_name": "mioEmbeddingIdConverter"},
          output_attr_name = "colossus_photo_semantic_id_list",
          client_side_shard = True,
          size = 3,
        ) \
        .explore_extract_universal_feature(
          ...
          user_info_attrs = {
            ...
            "user_profile_v1_click_pid_list_attr": "click_photo_id",
            "user_profile_v1_click_aid_list_attr": "click_author_id",
  ...
  # .enrich_attr_by_py(
    ...
    def retrieve(self):
      return self.enrich_attr_by_lua(
        ...
        export_common_attr = ["user_sid_int", "unique_sid_count"],
        lua_script = """
          function calculate()
            local user_sid_int = {}
    ...
    def post_process(self):
      return self.deduplicate() \
        ...
        .log_debug_info(
          ...
          respect_sample_logging = False,
          common_attrs = [
            "user_profile_v1_click_semantic_id_list",
          ],
          log_tag = "click_semantic_mxj"
        ) \
        .log_debug_info(
          for_debug_request_only = True,
          respect_sample_logging = False,
