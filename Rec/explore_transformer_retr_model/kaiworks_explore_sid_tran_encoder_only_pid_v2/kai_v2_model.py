...
if is_training:
    ...
    user_sid, user_sid_prob = model.beam_search_fast(beam_size=64, temperature=0.05)
    # user_sid, user_sid_prob = model.beam_search_fast_v2(beam_sizes=(16, 128, 1024), temperature=0.05)
