...
# global param
predict_server_name = "gr_explore_multi_query1_light_more"
model_queue_prefix="kaiworks_explore_sid_tran_multi_interest_decoder_only_Qformer_query1_light_more_final_copyy"
...
class ModelRetrFlow(LeafFlow, MioApiMixin, OfflineApiMixin, UniPredictApiMixin, ExploreModelApiMixin, RetrievalApiMixin, GsuApiMixin, EmbeddingApiMixin):
            ...
            self.uni_predict_fused(
              ...
              ## embedding 拉取相关配置，对应 fetch_mio_embedding 部分
               embedding_fetchers = [dict(
                ...
                colossusdb_embd_table_name="gr_multi_query1_light_more_gpu_final_copyy",
    ...
    def prepare(self):
      return self.get_abtest_params(
          biz_name = "RECO_RPC",
          ab_params = [
              ("hot_h3452_video_random_int_threshold", 0),
              ("hot_h3452_cover_level_random_int_threshold", 0)
          ]
        ) \
        .copy_user_meta_info(
          ...
          rule = {
            ...
            "filters": [
              ...
              },
              {
                "attr_name": "random_int",
                "remove_if": "<=",
                "compare_to": "{{hot_h3452_video_random_int_threshold}}"
              }
            ]
          }
        ) \
          ...
          rule = {
            ...
            "filters": [
              ...
              },
              {
                "attr_name": "random_cover_int",
                "remove_if": "<=",
                "compare_to": "{{hot_h3452_cover_level_random_int_threshold}}"
              }
            ]
          }
        ) \
