...
all_feats = {
    ...
    # === 用户行为序列特征 ===    
    "user_colossus_pid_list": {"expand": 1000, "share_id": 1},
    "user_colossus_aid_list": {"expand": 1000, "share_id": 2},
    
    "user_profile_v1_click_pid_list": {"expand": 200, "share_id": 1},  # 用户点击视频ID列表，展开为128个元素
    "user_profile_v1_click_aid_list": {"expand": 200, "share_id": 2},  # 用户点击作者ID列表，展开为128个元素
    
    "user_profile_v1_explore_click_pid_list": {"expand": 20, "share_id": 1},
    "user_profile_v1_explore_click_aid_list": {"expand": 20, "share_id": 2},
