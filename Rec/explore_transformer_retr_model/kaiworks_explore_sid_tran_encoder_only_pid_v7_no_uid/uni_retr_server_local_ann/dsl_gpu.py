...
# global param
predict_server_name = "grpc_exploreGRRetrV7"
    ...
    def prepare(self):
      return self.copy_user_meta_info(
        ...
        .fetch_remote_embedding(
          ...
          output_attr_name = "colossus_photo_float_sid_list",
          client_side_shard = True,
          size = 3,
        ) \
        .enrich_attr_by_light_function(
          import_common_attr = [
            {"name": "colossus_photo_float_sid_list", "as": "float_sid_list"}
          ],
          export_common_attr = [
            {"name": "semantic_id_list", "as": "colossus_photo_semantic_id_list" }
          ],
