...
# global param
predict_server_name = "grpc_exploreGRRetr256Neg"
model_queue_prefix="kaiworks_explore_sid_trans_yzc_v3_256_hard_neg_alpha_1"
            ...
            self.uni_predict_fused(
              ...
              ## embedding 拉取相关配置，对应 fetch_mio_embedding 部分
               embedding_fetchers = [dict(
                ...
                colossusdb_embd_table_name="gr_neg",
