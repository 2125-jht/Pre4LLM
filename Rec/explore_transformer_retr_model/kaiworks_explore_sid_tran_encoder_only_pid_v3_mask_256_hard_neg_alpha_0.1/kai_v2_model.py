...
if is_training:
    ...
    # === 模型前向传播 ===
    print("=== 模型前向传播 ===")
    loss, result_dict = model.model(photo_semantic_id, label, photo_semantic_id_int, label_click)  # 计算训练损失
    ...
    kai.add_run_hook(DumpTensorHook('dump_tensors', {
        ...
        'true0_probs': result_dict['true0_probs'],
        'true1_probs': result_dict['true1_probs'],
        'true2_probs': result_dict['true2_probs'],
