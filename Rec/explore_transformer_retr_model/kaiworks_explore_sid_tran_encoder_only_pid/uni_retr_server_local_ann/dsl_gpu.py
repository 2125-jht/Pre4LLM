...
# global param
predict_server_name = "grpc_exploreSidTransformerRetr"
        ...
        return (
            self.uni_predict_fused(
              ...
              batching_config = dict(
                batch_timeout_micros = 4500,													                    # 如果开启 batching，则配置 batching 的 timeout
              ...
              executor_config = dict(
                context_per_device=4,  				# 每张卡上设置的 context 个数，
                memory_size_per_context=5120, # 每个 context 占用的显存，单位 MB
              ),
            )
            .log_debug_info(
