...
model_queue_prefix="kaiworks_explore_sid_trans_yzc_v3"
...
class ModelRetrFlow(LeafFlow, MioApiMixin, OfflineApiMixin, UniPredictApiMixin, ExploreModelApiMixin, RetrievalApiMixin, GsuApiMixin, EmbeddingApiMixin):
            ...
            self.uni_predict_fused(
              ...
              ## embedding 拉取相关配置，对应 fetch_mio_embedding 部分
               embedding_fetchers = [dict(
                ...
                colossusdb_embd_table_name="yzc_sid_v3",
    ...
    def prepare(self):
      return self.copy_user_meta_info(
        ...
        .enrich_attr_by_lua(
          import_common_attr = ["colossus_photo_id_list", "colossus_author_id_list", "colossus_play_time_list",  "colossus_channel_list"],
          function_for_common = "calculate",
          export_common_attr = ["select_colossus_photo_id_list", "select_colossus_author_id_list", "colossus_photo_id_length_equal_author_id_length", "select_photo_id_length_equal_author_id_length"],
          lua_script = """
            function calculate()
        ...
        .perflog_attr_value(
          check_point="length",
          common_attrs=["colossus_photo_id_length_equal_author_id_length", "select_photo_id_length_equal_author_id_length"],
        ) \
        .log_debug_info(
          for_debug_request_only = True,
          respect_sample_logging = False,
          common_attrs = [
            "select_colossus_photo_id_list",
            "select_colossus_author_id_list"
          ]
        ) \
...
service.build(output_file=os.path.join(model_dir, "dynamic_json_config_gpu_v3.json"))
