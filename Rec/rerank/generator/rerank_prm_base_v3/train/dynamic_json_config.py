...
shard_num = 10
hot_loss = ['pos', 'hot_ctr', 'hot_like', 'hot_follow', 'hot_profile', 'hot_longview']
slide_loss = ['slide', 'slide_ctr', 'slide_interact', 'slide_longview', 'slide_evtr']
...
config_ps = {
    ...
    "model_loader": {
        ...
        "model_path": "viewfs:///home/reco_4/data/krp/xuwei09/krp_kuaishou_hot_krp_tf_training_server_hot-rerank-v2/checkpoints/1633996800",
        "producer": "kuiba",
        "shard_num": 16,
        "slots": [
        ],
    ...
    "metric": {
        "{}".format(name): [
            ...
            "xauc",
            "auc",
        ] for name in [hot_loss[i] + "_{}".format(pos) for i in range(len(hot_loss)) for pos in range(10)] + [slide_loss[i] + "_{}".format(pos) for i in range(len(slide_loss)) for pos in range(6)]
    },    
    "online_update": True,
