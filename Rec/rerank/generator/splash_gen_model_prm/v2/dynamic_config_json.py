...
predict_limit = 1200
predict_server_name = "grpc_splash_rerank_model_gen_ar_server"
model_queue_prefix = "splash_rerank_model_gen_ar_e2e"
colossusdb_embd_model_name = "splash_rerank_model_gen_ar"
colossusdb_embd_table_name = "splash_rerank_model_gen_ar_emb"
