    ...
    def predict_with_mio_model(self, **kwargs):
        ...
        return self \
            ...
            .pack_item_attr_to_item_attr(
              ...
              to_item_attr="fullrank_detail_pwtd_list",
              default_val=0.0
            ) \
            .pack_item_attr_to_item_attr(
              from_item_attrs=["fullrank_detail_pltr"],
              to_item_attr="fullrank_detail_pltr_list",
              default_val=0.0
            ) \
            .pack_item_attr_to_item_attr(
              from_item_attrs=["fullrank_act_wtd"],
              to_item_attr="fullrank_act_wtd_list",
              default_val=0.0
            ) \
            ...
            .end_if_() \
            .pack_item_attr_to_item_attr(
                # from_item_attrs = ["rerank_gen_score_0", "rerank_gen_score_1", "rerank_gen_score_2"], #! from score
                from_item_attrs = return_preds, #! from score
