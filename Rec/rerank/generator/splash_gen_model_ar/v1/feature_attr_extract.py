...
all_feats = {
  ...
  # # "user_follow_count": {"belong": "user"},
  # # "user_upload_count": {"belong": "user"},
  ...
  # "user_request_province_id": {"belong": "user"},
  # "user_request_city_id": {"belong": "user"},
  # "user_request_poi_type": {"belong": "user"},
  # "user_region_type": {"belong": "user"},

  # "user_realtime_click_list": {"expand":50, "dim": 64, "belong": "user_rt_pid_seq"},
  # "user_realtime_like_list": {"expand":50, "dim": 64, "belong": "user_rt_pid_seq"},
  # "user_realtime_follow_list": {"expand":50, "dim": 64, "belong": "user_rt_pid_seq"},
  # "user_realtime_forward_list": {"expand":50, "dim": 64, "belong": "user_rt_pid_seq"},

  # "user_fountain_profile_like_pid_list": {"expand":50, "dim": 64, "belong": "user_ft_pid_seq"},
  # "user_fountain_profile_like_aid_list": {"expand":50, "dim": 64, "belong": "user_ft_aid_seq"},
  # "user_fountain_profile_effective_view_pid_list": {"expand":50, "dim": 64, "belong": "user_ft_pid_seq"},
  # "user_fountain_profile_effective_view_aid_list": {"expand":50, "dim": 64, "belong": "user_ft_aid_seq"},
  # "user_fountain_profile_long_view_pid_list": {"expand":50, "dim": 64, "belong": "user_ft_pid_seq"},
  # "user_fountain_profile_long_view_aid_list": {"expand":50, "dim": 64, "belong": "user_ft_aid_seq"},

  # "photo_id": {"dim": 64, "belong": "item"},
  # "photo_author_id": {"dim": 64, "belong": "item"},
  # "photo_author_gender": {"dim": 4, "belong": "item"},
  # # "photo_upload_type": {"belong": "item"},
  ...
  # "context_source_aid": {"dim": 64, "belong": "source"},
...
def get_all_feature_attrs(all_feats):
    ...
    for k in all_feats.keys():
        if k in feature_pool_config.keys():
            ...
            elif belong == "user_ft_pid_seq":
              fountain_seq_pid_names.append(k)
            elif belong == "user_ft_aid_seq":
              fountain_seq_aid_names.append(k)
            elif belong == "source":
