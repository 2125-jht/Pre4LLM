...
kess_name = "grpc_splash_rerank_model_gen_pinrec_server"
all_model_preds = [
  "rerank_gen_score_"+str(i) for i in range(10)
]
all_model_preds.append("logits_0")
all_model_preds.append("preward")
    ...
    def predict_with_mio_model(self, **kwargs):
        ...
        return self \
            ...
            .pack_item_attr_to_item_attr(
              ...
              to_item_attr="duration_ms_list",
              default_val=0.0
            ) \
            .pack_item_attr_to_item_attr(
              from_item_attrs=["fullrank_detail_pwtd"],
              to_item_attr="context_info__pwtd_list",
              default_val=0.0
            ) \
            .pack_item_attr_to_item_attr(
              from_item_attrs=["fullrank_detail_pctr"],
              to_item_attr="context_info__pctr_list",
              default_val=0.0
            ) \
            .pack_item_attr_to_item_attr(
              from_item_attrs=["fullrank_detail_pltr"],
              to_item_attr="context_info__pltr_list",
              default_val=0.0
            ) \
            .pack_item_attr_to_item_attr(
              from_item_attrs=["fullrank_detail_pcmtr"],
              to_item_attr="context_info__pcmtr_list",
              default_val=0.0
            ) \
            .pack_item_attr_to_item_attr(
              from_item_attrs=["fullrank_detail_pwtr"],
              to_item_attr="context_info__pwtr_list",
              default_val=0.0
            ) \
            .pack_item_attr_to_item_attr(
              from_item_attrs=["fullrank_detail_pftr"],
              to_item_attr="context_info__pftr_list",
              default_val=0.0
            ) \
            .pack_item_attr_to_item_attr(
              from_item_attrs=["fullrank_detail_plvtr"],
              to_item_attr="context_info__plvtr_list",
              default_val=0.0
            ) \
            .pack_item_attr_to_item_attr(
              from_item_attrs=["fullrank_sim_psvr"],
              to_item_attr="context_info__psvtr_list",
              default_val=0.0
            ) \
            .pack_item_attr_to_item_attr(
            ...
            .perflog_attr_value(
                ...
                item_attrs = ["rerank_gen_score_"+str(i) for i in range(10)] + ["logits_0", "preward", "duration_ms_list",]
             ) \
            .log_debug_info(
                for_debug_request_only=False,
                item_num_limit = 10,
