...
reader_name = 'kuiba_tf_fountain_rerank_lh1'
...
#    "uExpClick", "uExpLike", "uExpFollow", "uExpLongView",
...
slide_user_basic = [
    "uId", "dId", "uBasicAge", "uGender", "uCityId", "uProvinceId","uRequestHour","uRequestWeekday",
    ...
    "fountainClickPids","fountainLikePids", "fountainFollowAids",
    "fountainLongviewPids", "fountainEffviewPids",
    "user_view_list_pids","user_view_list_aids","user_view_list_ev","user_view_list_lv","user_view_list_sv",
    "user_view_list_hetu1","user_view_list_hetu2"
]

# 32 * 2 + 24 * 2 + 8 * 4 + 4 * 4 + 16 * 5 = 240 
# 24
photo_xtr = [
  "pPctr", "pPltr", "pPwtr", "pPftr", "pPhtr", "pPptr", "pPcmtr",  "pMcPctr", "pMcPwtr", "pMcPltr",
  "pPlvtr", "pPsvtr", "pMcPlvtr", "pMcPsvtr", "pPvtr", "pPcmef", "pPepstr",
]

slide_photo_xtr = [
  "pPctr", "pPltr", "pPwtr", "pPftr", "pPhtr", "pPptr", "pPcmtr","pPepstr", "pPcmef",  "pMcPctr", "pMcPwtr", "pMcPltr",
  "pPvtr","pPwtd", "pPlvtr", "pPsvtr", "pMcPlvtr", "pMcPsvtr",
  "pPvtr_buck",
...
slide_photo_basic = [
    "pId", "aId",
    "pDurationMs", "pUploadType", "pCityId", "pProvinceId","pContentLevel",
    "pMusic","pMmuImgClusterV1", "pMmuImgClusterV3", "pMmuContentId","pHetuTagLevel1Id", "pHetuTagLevel2Id",
    #"pOcrCoverTextWordCount", "pMusicComboId",
    #"exp_show_low", "exp_show_high", "exp_click_low", "exp_click_high", "exp_like_low", "exp_like_high", "exp_follow_low", "exp_follow_high",
    #"exp_hate", "exp_report", "fans_count_low", "fans_count_high", "avg_watchtime",   
    "pCurrentPage","pAgeHour","position"
]
...
#input_eval_l2r = ltr_user + user_basic + photo_eval_ltr_side
...
input_slide_l2r = [atten + slide_user_basic + gen_slide_l2r_list_fea(i) for i in range(7)]
input_slide_next = [atten + slide_user_basic + gen_slide_l2r_next_fea(i) for i in range(7)]
input_slide_l2r = [slide_user_basic + gen_slide_l2r_list_fea(i) for i in range(7)]
...
print("cying_input_slide_l2r:",input_slide_l2r)
print("cying_input_slide_next:",input_slide_next)
print("cying_input_l2r:",input_l2r)
print("cying_input_list_all:",input_list_all)
...
def gen_loss():
  ...
  for i in [6]:
    neg = 'pListBottomNegLabel_' + str(i)
    pos = 'pListBottomPosLabel_' + str(i)
    #l2r_inputs = ["param." + p for p in input_bottom_l2r[i]]
    #labels = {neg: {}, pos : {"sample_rate": 1.0, "expired_output": [1.0]}}
    #loss.update({"bottom_l2r_" + str(i) : {"type": "LogLoss", "inputs": l2r_inputs, "labels": labels, "auc_uid": "uId"}})
    #loss.update({"bottom_ctr_" + str(i) : {"type": "LogLoss", "inputs": l2r_inputs, "labels": labels, "auc_uid": "uId"}})
    #loss.update({"bottom_vtr_" + str(i) : {"type": "LogLoss", "inputs": l2r_inputs, "labels": labels, "auc_uid": "uId"}})

  return loss

print('user_fea_num = {}'.format(len(user_basic)))
print('slide_user_fea_num = {}'.format(len(slide_user_basic)))
print('photo_fea_num = {}'.format(len(slide_photo_basic + slide_photo_xtr)))
