...
hdfs_path="viewfs://hadoop-lt-cluster/home/reco_analysis_log/rawdata/reco_hot_context_rank_joint_log/%Y-%m-%d/%H/*"
...
# 这个最好 kml 做渲染
reader_name="mio_kai_fountain_rerank_wtd_v1"
...
if args.run:
  ...
  output_file_name = "pipeline_eval.json" if args.mode == 'train' else "eval_pipeline.json"
