...
class PredictServerFlow(LeafFlow, KuibaApiMixin, MioApiMixin, OfflineApiMixin, GsuApiMixin, CofeaApiMixin, UniPredictApiMixin, CommonApiMixin, ExploreModelApiMixin):
    def predict_with_mio_model(self, **kwargs):
        ...
        batch_size = kwargs.pop("batch_size", [600, 500, 200])
        ...
        return self \
            ...
            .explore_extract_universal_feature(
              ...
              context_info_item_attrs = {
                ...
                "context_source_pid_attr": "context_info__source_pid",
                "context_source_aid_attr": "context_info__source_photo_info__author__id",
                "context_source_hetu_tag_level1_list_attr": "context_info__source_photo_info__hetu_tag_level_info__hetu_level_one",
                "context_source_hetu_tag_level2_list_attr": "context_info__source_photo_info__hetu_tag_level_info__hetu_level_two",
              },
            ) \
