...
kess_name = "grpc_splash_rerank_model_gen_ar"
all_model_preds = [
  "pctr",
  "pslide",
  "pwtd",
    ...
    def predict_with_mio_model(self, **kwargs):
        ...
        return self \
            ...
            .get_abtest_params(
              ...
              device_id = "{{device_id}}",
              ab_params = [
                ("fountain_splash_rerank_eval_list_pctr_weight", 1.0, "pctr_weight"),
                ("fountain_splash_rerank_eval_list_pwtd_weight", 1.0, "pwtd_weight"),
                ("fountain_splash_rerank_eval_list_pvtr_weight", 1.0, "pvtr_weight"),
                ("fountain_splash_rerank_eval_list_pltr_weight", 1.0, "pltr_weight"),
                ("fountain_splash_rerank_eval_list_pslide_weight", 0.0, "pslide_weight"),
                ("fountain_splash_rerank_eval_list_context_pctr_weight", 0.0, "context_pctr_weight"),
                ("fountain_splash_rerank_eval_list_context_pwtd_weight", 0.0, "context_pwtd_weight"),
                ("fountain_splash_rerank_eval_list_context_pltr_weight", 0.0, "context_pltr_weight"),
                ("fountain_splash_rerank_eval_list_context_pwtr_weight", 0.0, "context_pwtr_weight"),
                ("fountain_splash_rerank_eval_list_context_pcmtr_weight", 0.0, "context_pcmtr_weight"),
              ]
            ) \
            .enrich_attr_by_light_function(
              import_common_attr = [
                {"name": "user_info", "as": "user_info_ptr"},
              ],
              export_common_attr = [
                {"name": "splash_view_source_ids", "as": "user_splash_source_view_pid_list"},
                {"name": "splash_view_target_ids", "as": "user_splash_target_view_pid_list"},
                {"name": "splash_view_source_tags", "as": "user_splash_source_view_hetu1_list"},
                {"name": "splash_view_target_tags", "as": "user_splash_target_view_hetu1_list"},
              ],
              function_name = "GetSplashViewPairList",
            ...
            .enrich_attr_by_light_function(
              ...
              export_common_attr = [
                {"name": "splash_long_term_view_source_ids", "as": "user_splash_long_term_source_view_pid_list"},
                {"name": "splash_long_term_view_target_ids", "as": "user_splash_long_term_target_view_pid_list"},
                {"name": "splash_long_term_view_source_tags", "as": "user_splash_long_term_source_view_hetu1_list"},
                {"name": "splash_long_term_view_target_tags", "as": "user_splash_long_term_target_view_hetu1_list"},
              ],
              function_name = "GetSplashLongTermViewPairList",
              class_name = "ExploreModelLightFunctionSet",
            ) \
            ...
            .gen_common_attr_by_lua(
              attr_map={
                "user_splash_long_term_source_view_pid_list_size": "(user_splash_long_term_source_view_pid_list and #user_splash_long_term_source_view_pid_list > 0) and #user_splash_long_term_source_view_pid_list or 0",
                "user_splash_source_view_pid_list_size": "(user_splash_source_view_pid_list and #user_splash_source_view_pid_list > 0) and #user_splash_source_view_pid_list or 0",
              }
            ) \
            ...
            .if_("item_num >= 30 or rerank_list_item_idx_flat_list == nil") \
              .uni_predict_fused(
              ...
              .enrich_attr_by_lua(
                ...
                import_common_attr=["pctr", "pwtd", "pvtr", "pltr", "context_pctr", "context_pwtd", "context_pltr", "context_pcmtr", "context_pwtr", "pslide", "pctr_weight", "pwtd_weight", "pvtr_weight", "pltr_weight", "pslide_weight", "context_pctr_weight", "context_pwtd_weight", "context_pltr_weight", "context_pwtr_weight", "context_pcmtr_weight", "rerank_list_item_idx_flat_list_max_size", "rerank_list_item_size", "rerank_list_true_num"],
                    ...
                    for i = 1, list_num do
                      ...
                      if i < rerank_list_true_num + 1 then
                        for j = 1, rerank_list_item_size do
                          ...
                          local pslide_reward = pslide_weight * pslide[start_idx + j] * 10.0
                          local element_score = context_pwtd_reward + context_pctr_reward + context_pltr_reward + context_pcmtr_reward + context_pwtr_reward + pvtr_reward + pctr_reward + pslide_reward + pltr_reward
                          es_i = es_i + element_score * (1 / (0.3 + j^1.2))
                        end
                      end
                      scores[i] = es_i
                    end
