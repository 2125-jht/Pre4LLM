...
kess_name = "grpc_fountain_rerank_eval_listwise_infer"
all_model_preds = [
  "pctr",
  "pwtd",
  "pvtr",
        ...
        return self \
            ...
            .if_("item_num >= 60") \
              ...
              .enrich_attr_by_lua(
                ...
                import_common_attr=[
                  "pctr", "pwtd", "pvtr", "pltr",
                  "expected_list_watch_time", "expected_list_effective_vv", "expected_consume_length",
                  ...
                  "expected_list_watch_time_weight", "expected_list_effective_vv_weight",
                ],
                ...
                lua_script="""
                  ...
                  function calculate_list_scores()
                    ...
                    for i = 1, list_num do
                      ...
                      local fusion_score = watch_time_score_delta + effective_vv_score_delta
