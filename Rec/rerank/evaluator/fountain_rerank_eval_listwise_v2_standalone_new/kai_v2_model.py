...
# 当前 TB 中 weight=0.1 时 Preference 约占总 loss 4%；提升到 0.4 后
# 预计占比约 14%。实际占比由 loss_contribution/preference_ratio 监控。
...
if is_training:
    ...
    # Y_l/Y_w 都保留完整 6-item suffix；只在真实曝光 Prefix 内按反馈重排。
