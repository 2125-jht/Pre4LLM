...
SAMPLE_HDFS_PATH = "viewfs://hadoop-lt-cluster/home/reco_analysis/dw/reco_analysis.db/explore_reco_log_sample_rel/p_date=%Y%m%d/*#no_next=wait&no_current=wait&step=86400"
...
SAMPLE_ITEM_ATTRS = [  
    ...
    {"column_index": 22, "column_name": "emp_ctr_list", "type": "string_list"},
    {"column_index": 23, "column_name": "emp_ltr_list", "type": "string_list"},
    {"column_index": 24, "column_name": "emp_wtr_list", "type": "string_list"},
    {"column_index": 25, "column_name": "emp_ftr_list", "type": "string_list"},
    {"column_index": 26, "column_name": "emp_lvtr_list", "type": "string_list"},
    ...
    {"column_index": 35, "column_name": "hetu_level_one_tag_list", "type": "string_list"},
    {"column_index": 36, "column_name": "hetu_level_two_tag_list", "type": "string_list"},
    {"column_index": 37, "column_name": "hetu_level_three_tag_list", "type": "string_list"},
    {"column_index": 38, "column_name": "pctr_list", "type": "string_list"},
    {"column_index": 39, "column_name": "pltr_list", "type": "string_list"},
    {"column_index": 40, "column_name": "pwtr_list", "type": "string_list"},
    {"column_index": 41, "column_name": "pftr_list", "type": "string_list"},
    {"column_index": 42, "column_name": "plvtr_list", "type": "string_list"},
    {"column_index": 43, "column_name": "pptr_list", "type": "string_list"},
    {"column_index": 44, "column_name": "psvtr_list", "type": "string_list"},
    {"column_index": 45, "column_name": "pwtd_score_list", "type": "string_list"},
    {"column_index": 46, "column_name": "pcltr_list", "type": "string_list"},
    {"column_index": 47, "column_name": "pcmef_list", "type": "string_list"},
    {"column_index": 48, "column_name": "pcmtr_list", "type": "string_list"},
    {"column_index": 49, "column_name": "mc_htr_list", "type": "string_list"},
    {"column_index": 50, "column_name": "mc_pcestr_list", "type": "string_list"},
    {"column_index": 51, "column_name": "mc_pcltr_list", "type": "string_list"},
    {"column_index": 52, "column_name": "mc_pcmtr_list", "type": "string_list"},
    {"column_index": 53, "column_name": "mc_pctr_list", "type": "string_list"},
    {"column_index": 54, "column_name": "mc_pepstr_list", "type": "string_list"},
    {"column_index": 55, "column_name": "mc_pltr_list", "type": "string_list"},
    {"column_index": 56, "column_name": "mc_plvtr_list", "type": "string_list"},
    {"column_index": 57, "column_name": "mc_psvtr_list", "type": "string_list"},
    {"column_index": 58, "column_name": "mc_pwtd_list", "type": "string_list"},
    {"column_index": 59, "column_name": "mc_pwtr_list", "type": "string_list"},
...
class DataReaderFlow(LeafFlow, MioApiMixin, KuibaApiMixin, OfflineApiMixin, GsuApiMixin):
    ...
    def process_feat(self):
        ...
        .enrich_attr_by_lua(
            ...
            .enrich_attr_by_lua( # ["13","34","11","11","11","34","12","68_6","5","34"]
                import_item_attr=[
                ...
                function_for_item="process_hetu_feature",
                lua_script_file="util.lua"
            ) \
    # .enrich_attr_by_lua(
...
load_raw_sample = (
    ...
    .log_debug_info(
        ...
        item_attrs = [
            ...
            "author_id_list",
            "author_gender_list",
            "point_ltr_label", "point_ltr_wt","session_inner_time","session_vv","is_revisit"
        ],
