...
predict_limit = 1200
predict_server_name = "grpc_fountain_rerank_eval_listwise_v1_server"
# 梯度隔离实验使用独立模型队列，避免误拉取或覆盖原 v2 参数。
model_queue_prefix = "fountain_rerank_eval_listwise_v2_grad_isolated"
colossusdb_embd_model_name = "explore_evaluator_sid_test" # 暂时用的别人已有的服务，改不了名字
colossusdb_embd_table_name = "fountain_rerank_eval_listwise_table"
