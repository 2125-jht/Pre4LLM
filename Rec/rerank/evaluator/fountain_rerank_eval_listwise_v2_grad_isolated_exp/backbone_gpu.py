...
class PredictServerFlow(LeafFlow, KuibaApiMixin, MioApiMixin, OfflineApiMixin, GsuApiMixin, CofeaApiMixin, UniPredictApiMixin, CommonApiMixin, ExploreModelApiMixin):
    def predict_with_mio_model(self, **kwargs):
        ...
        batch_size = kwargs.pop("batch_size", [500, 300, 150])
        ...
        return self \
            ...
            .uni_predict_fused(
                ...
                executor_config=dict(
                    inter_op_parallelism_threads_num=1,
                    intra_op_parallelism_threads_num=1,
                    context_per_device=20,         # gpu
                    memory_size_per_context=200 # gpu
                  ...
                  for i = 1, list_num do
                    ...
                    if i < rerank_list_true_num + 1 then
                      for j = 1, rerank_list_item_size do
                        ...
                        local element_score = context_pwtd_reward + context_pctr_reward + context_plvtr_reward + context_psvtr_reward + context_pltr_reward + context_pcmtr_reward + context_pwtr_reward + context_pftr_reward + pvtr_reward + pltr_reward + pctr_reward + pwtd_reward
