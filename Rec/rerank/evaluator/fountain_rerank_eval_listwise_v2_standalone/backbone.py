        ...
        return self \
            ...
            .get_abtest_params(
              ...
              ab_params = [
                ...
                # Standalone List 分支作为外部分数基线之上的增量项。
            ...
            .if_("item_num >= 60") \
              ...
              .enrich_attr_by_lua(
                ...
                import_common_attr=[
                  "expected_list_watch_time", "expected_list_effective_vv",
                  "expected_list_interaction", "expected_consume_length",
                  ...
                  "expected_list_interaction_weight", "expected_consume_length_weight",
                ],
                ...
                lua_script="""
                  -- 外部 fullrank 分数保持 v2 的 item -> List 聚合和融合逻辑；
                  -- standalone 的三个 List 级预测作为该基线之上的增量项。
                  ...
                  local function calc_order_es_scores(list_num, list_score_weight_pairs)
                    ...
                    for _, pair in ipairs(list_score_weight_pairs) do
                      local score_pairs = {}
                      for i = 1, list_num do
                        local s = pair.list ~= nil and (pair.list[i] or 0.0) or 0.0
                      ...
                      for i = 1, #score_pairs do
                        ...
                        es_scores[sp.idx] = es_scores[sp.idx] * (1.0 / (rank + 10.0)) ^ pair.weight
                      end
                    end
                    return es_scores
                  end
                  ...
                  function calculate_list_scores()
                    ...
                    for i = 1, list_num do
                      if i <= true_num then
                        scores[i] =
                          safe_list_value(context_scores, i)
