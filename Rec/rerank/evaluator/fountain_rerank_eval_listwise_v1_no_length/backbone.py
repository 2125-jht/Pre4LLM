        ...
        return self \
            ...
            .get_abtest_params(
              ...
              ab_params = [
                ...
                # List Value 分支与 standalone 使用同一套 WT/EVV AB 参数名；weight=0 即关闭。
              ...
              .enrich_attr_by_lua(
                ...
                lua_script="""
                  ...
                  function calculate_list_scores()
                    ...
                    -- list_value_scores = 本模型 List Value 两个直接总价值 head 的加权贡献；
