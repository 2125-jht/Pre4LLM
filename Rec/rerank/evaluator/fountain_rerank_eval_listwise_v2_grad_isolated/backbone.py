        ...
        return self \
            ...
            .if_("item_num >= 60") \
              ...
              .enrich_attr_by_lua(
                ...
                import_common_attr=[
                  "pctr", "pwtd", "pvtr", "pltr",
                  "expected_list_watch_time", "expected_list_effective_vv", "expected_list_interaction", "expected_consume_length",
                  ...
                  "pctr_weight", "pwtd_weight", "pvtr_weight", "pltr_weight", "pslide_weight",
                ...
                lua_script="""
                  ...
                  function calculate_list_scores()
                    local n = #pvtr
                    if n ~= rerank_list_item_idx_flat_list_max_size or n ~= #pltr or n % rerank_list_item_size ~= 0 then
            ...
            .log_debug_info(
              ...
              common_attrs = [
                ...
                "expected_wt_weight",
                "expected_ltr_weight",
                "expected_pctr_weight",
                "expected_like_weight",
                "expected_comment_weight",
                "expected_follow_weight",
                "context_pwtd_weight",
                "pctr_weight",
              ],
              item_attrs = [
