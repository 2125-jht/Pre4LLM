        ...
        return self \
            ...
            .get_abtest_params(
              ...
              ab_params = [
                ...
                ("fountain_splash_rerank_eval_list_pwtd_weight", 0.0, "pwtd_weight"),
                    ...
                    for i = 1, list_num do
                      ...
                      if i < rerank_list_true_num + 1 then
                        for j = 1, rerank_list_item_size do
                          local adj_pctr = pctr_weight * pctr[start_idx + j]
                          local adj_pvtr = pvtr_weight * pvtr[start_idx + j] / 10.0
                          local adj_pltr = pltr_weight * pltr[start_idx + j] * 100.0
                          local element_score = adj_pctr * adj_pvtr * adj_pltr
