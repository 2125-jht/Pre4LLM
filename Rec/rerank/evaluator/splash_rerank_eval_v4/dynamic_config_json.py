...
predict_limit = 1200
predict_server_name = "grpc_splash_rerank_eval_mtl_v2_server_new"
model_queue_prefix = "splash_rerank_model_prm_v2"
colossusdb_embd_model_name = "splash_rerank_model_evaluator_mtl_v2"
colossusdb_embd_table_name = "splash_rerank_model_evaluator_mtl_v2_emb_new_2shard"
