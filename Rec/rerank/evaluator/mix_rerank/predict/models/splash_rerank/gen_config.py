...
slide_user_basic = [
    "uId", "dId",
    "uClickPids", "uLikePids", "uHatePids", "uFollowAids", "uLikeAids",
    "uExpClick", "uExpLike", "uExpFollow", "uExpLongView",
    "uBasicAge", "uGender", "uCityId", "uProvinceId",
    #"uRequestHour", "uRequestWeekday",
    ...
    #"fountainLikePids", "fountainFollowAids",
...
slide_photo_xtr = [
  "pctr", "pltr", "pwtr", "pftr", "phtr", "pptr", "pcmtr", "mcPctr", "mcPwtr", "mcPltr", 
  "pvtr", "pcmef", "plvtr", "psvtr", "pepstr", "mcPlvtr", "mcPsvtr",
]
...
slide_photo_basic = [
    "pId", 
    "aId",
    "pDurationMs", "pUploadType", "pCityId", "pProvinceId",
    "pMusic",
    "pMmuImgClusterV1", "pMmuImgClusterV3", "pMmuContentId",
    ...
    "pEmpCtr", "pEmpLtr", "pEmpWtr", "pEmpFtr", "pEmpCmtr", "pEmpHtr", "pEmpPtr",
    "pHetuTagLevel1Id", "pHetuTagLevel2Id", "pContentLevel", "avg_watchtime"
]
...
input_list_all = input_slide_l2r[6] + input_l2r[10]
...
print('photo_fea_num = {}'.format(len(slide_photo_basic + photo_xtr)))
