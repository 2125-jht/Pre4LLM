...
class CascadingCalcXhsTypeAttrModule(CommonModule):
  ...
  def process(self) -> None:
    self.flow \
      .if_("enable_calc_xhs_type_picture == 1", to_be_delete = "date=2024-05-29;committer=hanbiyun") \
      ...
      .if_("enable_calc_xhs_target_qualified_photo == 1") \
        .if_("enable_calc_xhs_target_photo_new_category == 1", to_be_delete = "date=2023-11-16;committer=shaolei") \
          .copy_attr(
