...
from cascading.module.queue.directly_reach_fullrank_queue import DirectlyReachFullrankQueueFinalScorer
...
class CascadingFinalChannelSortModule(CommonModule):
  ...
  def process(self) -> None:
    ...
    self.flow._dump_attr_to_kafka(
      ...
      dump_item_attr_list = [
        ...
        "explore_cold_photo_score_mc_s2",
  ...
  def _define_scorers(self):
    scorers = {
      ...
      'directly_reach_fullrank': DirectlyReachFullrankQueueFinalScorer(self._stage() + '_directly_reach_fullrank', self.flow, self.config)
    }
    return scorers
  ...
  def calc_result_count_to_ab_metric(self):
    return self.flow \
      ...
      .count_reco_result(
        save_count_to = "cascade_s2_all_page_valid_interest_count",
      ...
      .count_reco_result(
        save_count_to = "cascade_s2_outer_field_interest_count",
      ...
      .count_reco_result(
        save_count_to = "cascade_s2_bias_interest_count",
        target_item = {"is_bias_interest_tagnex": 1},
      ) \
      .send_abtest_metrics(
        metrics = [
          "cascade_s2_bias_interest_count",
          "cascade_s2_follow_author_count",
          "cascade_s2_top200_prerank_index_avg",
          "cascade_s2_all_page_valid_interest_count",
          "cascade_s2_new_interest_count",
          "cascade_s2_outer_field_interest_count",
    ...
    self.flow \
      .if_("enable_explore_pic_cluster_counter == 1") \
        ...
        .enrich_attr_by_light_function(
          ...
          export_common_attr = [
            {"name": "cluster_count", "as": "mc_s2_pic_cluster_count"},
            {"name": "long_interest_count", "as": "mc_s2_pic_long_interest_count"},
            {"name": "valid_interest_count", "as": "mc_s2_pic_valid_interest_count"},
            {"name": "pic_single_valid_interest_count", "as": "mc_s2_pic_single_valid_interest_count"},
            {"name": "pic_double_valid_interest_count", "as": "mc_s2_pic_double_valid_interest_count"},
            {"name": "recent_search_interest_count", "as": "mc_s2_pic_recent_search_interest_count"},
          ],
