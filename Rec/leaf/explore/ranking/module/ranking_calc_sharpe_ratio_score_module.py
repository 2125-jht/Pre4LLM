      ...
      .if_("enable_fr_cal_sharpe_ratio_score == 1 and basic_info_age_segment_v2 ~= explore_fr_cal_sharpe_ratio_score_skip_age") \
        .enrich_attr_by_light_function(
          import_common_attr = [
            ...
            {"name": "explore_fr_cal_sharpe_ratio_score_lvtr2_weight", "as": "fr_cascade_linear_score_lvtr2_weight"},
          ],
          import_item_attr = [
            ...
            {"name": "fr_score1", "as": "cascade_plvtr"},
            {"name": "pevtr", "as": "cascade_plvtr2"},
          ],
          export_item_attr = [
