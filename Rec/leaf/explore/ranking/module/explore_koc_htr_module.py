...
class ExploreKocHtrModule(CommonModule):
  ...
  def process(self) -> None:
    self.flow \
      .if_("enable_explore_koc_htr_model == 1 and recent_hate_count > explore_koc_htr_count_threshold") \
        ...
        .delegate_enrich(
          name = "explore_koc_htr",
          kess_service = "{{explore_koc_htr_kess_service}}",
          recv_item_attrs = [
            {"name": "cover_htr", "as": "koc_cover_htr"},
            {"name": "detail_htr", "as": "koc_detail_htr"},
            {"name": "reverse_cover_htr", "as": "reverse_koc_cover_htr"},
            {"name": "reverse_detail_htr", "as": "reverse_koc_detail_htr"},
          ],
          timeout_ms = 100,
          ...
          partition_size = "{{explore_koc_htr_partition_size}}",
        ) \
      .end_if_()
