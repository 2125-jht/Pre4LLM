...
class RankingCalcPairwiseRankScoreModule(CommonModule):
  ...
  def process(self) -> None:
    self.flow \
      .if_("enable_fr_cal_pairwise_rank_score == 1", to_be_delete = "date=2024-05-29;committer=liucong03") \
      ...
      .end_() \
      .if_("enable_fr_cal_ctr_pairwise_rank_score == 1", to_be_delete = "date=2024-05-29;committer=liucong03") \
