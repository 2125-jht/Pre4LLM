...
class ExploreEffectiveFollowUAModule(CommonModule):
  ...
  def process(self) -> None:
    self.flow \
      .if_("enable_explore_effective_follow_ua_model == 1") \
        ...
        .delegate_enrich(
          kess_service = "{{explore_effective_follow_ua_kess_service_name}}",
          request_type = "{{explore_effective_follow_ua_model_request_type}}",
          recv_item_attrs = [
          ...
          partition_size = "{{explore_effective_follow_ua_partition_size}}",
        ) \
      .end_()