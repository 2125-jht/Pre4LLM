...
class RankingFlow(CommonRecoFlow, subdivisionApiMixin, RetrievalApiMixin, GsuApiMixin, ExploreRankingStrategyMixin, ExploreApiMixin):
  def __init__(self, name: str) -> None:
    super().__init__(name, "explore", "ranking", "config", "module", "config/module", "lua/module", optimize_processor_order = True)
