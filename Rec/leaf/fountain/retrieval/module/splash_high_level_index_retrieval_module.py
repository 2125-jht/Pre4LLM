...
class SplashHighLevelIndexRetrievalModule(RetrievalModule):
  ...
  def process(self) -> None:
    self.flow \
      ...
      .retrieve_by_remote_index(
        kess_service = "{{fountain_splash_high_level_index_retr_services}}",
        timeout_ms = 150,
        reason = self.reason,
        common_query = "",
        querys = [{
          ...
          "random_search": 1,
          "search_num": "{{fountain_splash_high_level_index_search_num}}",
        },
        {
          "query": "hetuTagLevelTwo:{{source_hetu_level_two_v2}}",
          "random_search": 1,
          "search_num": "{{fountain_splash_high_level_index_search_num_source}}",
        }],
