...
class RerankFlow(CommonRecoFlow, subdivisionApiMixin, ExploreApiMixin, ExploreLifeApiMixin):
  def __init__(self, name: str) -> None:
    super().__init__(name, "life", "rerank", "config", "module", "config/module", "lua/module", optimize_processor_order = True)
