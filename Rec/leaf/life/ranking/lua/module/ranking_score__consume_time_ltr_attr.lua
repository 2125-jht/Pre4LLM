function calculate_changed()
    ...
    return pctr_ori, pctr, pltr, pwtr, pftr, psvr, pcmtr, pptr, pcmef, phtr, pevtr, fr_score1, fr_score2, fr_score1, fr_score2,
           pdtr, fetr, fountain_eff, 0.0, cascade_pctr, cascade_pltr, cascade_pwtr, cascade_plvtr, cascade_psvtr, 1, 1,
           ...
           hetu_tag_level_info__hetu_cluster_id, total_report_count, infer_gender, infer_year
end
