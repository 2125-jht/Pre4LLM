...
function awesome_wtd_score_change()
    local pctr_weight = awesome_wtd_pctr_weight or 0.0
    local wtd_weight = awesome_wtd_awesome_wtd_weight or 0.0
    local pctr = corr_pctr or 0.0
    local awesome_wtd_new = awesome_wtd or 0.0
    local score = pctr ^ pctr_weight * awesome_wtd_new ^ wtd_weight
    return score
end
