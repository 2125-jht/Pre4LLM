    ...
    self.flow \
      .else_() \
        ...
        .if_("mc_enable_opt_card_trigger == 1") \
          ...
          .end_() \
        .end_() \
        .if_("enable_interaction_trigger > 0 and profile_v1_interaction_trigger_list ~= nil and #profile_v1_interaction_trigger_list > 0") \
          .copy_attr(
            attrs=[{
          ...
          .if_("enable_interaction_trigger_shuffle > 0") \
            .shuffle_list_attr(
              common_attr = "interaction_trigger_list"
            ) \
          .end_() \
          .limit(
        ...
        .else_() \
          .if_("enable_shuffle_play_list > 0") \
            .enrich_with_protobuf(
              from_extra_var = "user_info_ptr",
              attrs = [
      ...
      .enrich_attr_by_lua(
        ...
        function_for_common = "calculate",
        lua_script_file = "life/retrieval/lua/module/colossus_ann__process_embedding.lua"
      ) \
