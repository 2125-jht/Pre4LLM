...
class LifeUserUploadPhotoI2iRetrievalModule(RetrievalModule):
  ...
  def process(self) -> None:
    self.flow \
        ...
        redis_params = [
          {
            ...
            "output_attr_name": "upload_list"
          }
        ]
      ) \
      .split_string(
        input_common_attr = "upload_list",
        output_common_attr = "upload_pid_list",
        delimiters=",",
        parse_to_int = True
      ) \
      .get_remote_embedding(
        ...
        item_list_from_attr = "upload_pid_list",
