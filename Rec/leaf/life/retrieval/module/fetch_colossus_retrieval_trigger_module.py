...
class FetchColossusRetrievalTriggerModule(CommonModule):
  ...
  def process(self):
    self.flow \
      .if_("enable_target_item_hetu_set > 0") \
        .copy_attr(
          attrs = [{
      ...
      .if_("colossus_user_info__trigger_id_list ~= nil and #colossus_user_info__trigger_id_list > 0") \
        ...
        .if_("enable_knowledge_trigger > 0") \
          .enrich_attr_by_lua(
            ...
            lua_script_file = "life/retrieval/lua/module/colossus_user_info__fetch_knowledge_trigger.lua"
          ) \
          .if_("enable_knowledge_trigger_shuffle > 0") \
            .shuffle_list_attr(
              common_attr = "colossus_user_info__knowledge_trigger_set"
            ) \
          .end_() \
        .end_() \
        .if_("enable_interest_explore_trigger > 0") \
          .enrich_attr_by_light_function(
            import_common_attr = [
              "colossus_user_info__trigger_tag_list",
              "colossus_user_info__trigger_id_list",
              "colossus_user_info__trigger_weight_list",
              {"name": "colossus_explore_hetu_tags", "as": "interest_explore_hetu_set"},
              "interest_explore_trigger_play_time_ths"
            ],
            export_common_attr = ["colossus_user_info__interest_explore_trigger_set"],
            function_name = "FetchInterestExploreTrigger",
      ...
      .else_() \
        ...
        .if_("enable_knowledge_trigger_shuffle > 0 and enable_knowledge_trigger > 0") \
            .shuffle_list_attr(
              common_attr = "colossus_user_info__knowledge_trigger_set"
            ) \
        .end_() \
