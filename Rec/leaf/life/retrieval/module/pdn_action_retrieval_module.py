  ...
  def process(self) -> None:
    ...
    self.flow \
      .else_() \
        ...
        .if_("enable_pdn_action_fountain_trigger > 0") \
          .limit(
            item_list_from_attr="fountain_like_list",
            size="{{explore_fountain_like_limit}}"
          ) \
          .limit(
            item_list_from_attr="fountain_follow_list",
            size="{{explore_fountain_follow_limit}}"
          ) \
          .limit(
            item_list_from_attr="fountain_forward_list",
            size="{{explore_fountain_forward_limit}}"
          ) \
          .limit(
            item_list_from_attr="fountain_comment_list",
            size="{{explore_fountain_comment_limit}}"
          ) \
          .pack_common_attr(
            input_common_attrs = ["fountain_like_list", "like_list"],
            output_common_attr = "like_list",
            limit="{{explore_pdn_action_like_limit}}"
          ) \
          .pack_common_attr(
            input_common_attrs = ["fountain_follow_list", "follow_list"],
            output_common_attr = "follow_list",
            limit="{{explore_pdn_action_follow_limit}}"
          ) \
          .pack_common_attr(
            input_common_attrs = ["fountain_forward_list", "forward_list"],
            output_common_attr = "forward_list",
            limit="{{explore_pdn_action_forward_limit}}"
          ) \
          .pack_common_attr(
            input_common_attrs = ["fountain_comment_list", "comment_list"],
            output_common_attr = "comment_list",
            limit="{{explore_pdn_action_comment_limit}}"
          ) \
        .end_() \
        .split_string(
        ...
        .enrich_attr_by_lua(
          ...
          lua_script_file = "life/retrieval/lua/module/pdn_action_retr__gen_trigger_weight.lua"
        ) \
        .shuffle_list_attr(
