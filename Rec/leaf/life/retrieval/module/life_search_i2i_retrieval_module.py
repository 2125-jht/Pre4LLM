...
class LifeSearchI2iRetrievalModule(RetrievalModule):
  ...
  def process(self) -> None:
    self.flow \
        ...
        redis_params = [
          {
            ...
            "output_attr_name": "search_list"
          }
        ]
      ) \
      .split_string(
        input_common_attr = "search_list",
        output_common_attr = "search_pid_list",
        delimiters=",",
        parse_to_int = True
      ) \
      .get_remote_embedding(
        ...
        item_list_from_attr = "search_pid_list",
