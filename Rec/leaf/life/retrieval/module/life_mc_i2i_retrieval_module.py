  ...
  def process(self) -> None:
    self.flow.pack_common_attr(
      ...
      .pack_common_attr(
        ...
        output_common_attr = "seed_photos",
        limit = "{{life_mc_i2i_seed_photo_size}}"
      ) \
      .get_remote_embedding(
        kess_service = "{{life_mc_i2i_embedding_service_name}}",
      ...
      .retrieve_by_ann_embedding(
        kess_service = "{{life_mc_i2i_ann_service_name}}",
        space = "cosine",
        timeout_ms = 100,
        reason = self.reason,
        shard_num = 1,
        ...
        bound_type = {
          "total_limit": "{{life_mc_i2i_result_num}}",
        },
        algo_type = {
          "scann": {},
        },
        src_bucket = "photo",
        dest_bucket = "{{life_mc_i2i_retr_dest_bucket}}",
      ) \
      .deduplicate()
