...
\datedsubsection{\textbf{大模型推理能力增强} 
\quad\quad\quad\quad
\textit{基于解码概率奖励的后训练}}{2025.09 - 2025.12}
\begin{itemize}
  \item \textbf{项目描述:} 
  % 需要提升基座模型的通用推理能力以支撑智能体在复杂场景下的逻辑推演与知识应用。
  面向复杂场景下逻辑推演的需求，整体采用\textbf{冷启动 SFT + RLPR 两阶段训练范式}。
  
  \item \textbf{训练数据:} 
  % 整体采用\textbf{冷启动 SFT + RLPR 两阶段训练}。
...
\quad\quad
\textit{基于动作级信用分配与可验证过程奖励}}{2026.05 - 2026.07}
\begin{itemize}
  \item \textbf{项目描述:}
